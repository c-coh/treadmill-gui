...
void DataPanel::initialize(tgui::Gui &gui)
{
    ...
    m_panel->setSize(ThemeManager::Layout::HALF_PANEL_WIDTH, ThemeManager::Layout::DATA_PANEL_HEIGHT);
    m_panel->setPosition(ThemeManager::Layout::DATA_PANEL_X, ThemeManager::Layout::DATA_PANEL_Y);
